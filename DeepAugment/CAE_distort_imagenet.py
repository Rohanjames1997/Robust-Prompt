...
all_classes = ["n01440764", "n01443537", "n01484850", "n01491361", "n01494475", "n01496331", "n01498041", "n01514668",
...
class FolderWithPath():
    ...
    def run_distortion(self):
        ...
        for image, target in tqdm(self.loader):
            ...
            save_path = './CAE_graphic/' + str(target.item()) + '/'
            save_path1 = './CAE_graphic/' + str(target.item()) + '/'

            if not os.path.exists(save_path):
                os.makedirs(save_path)

            save_path += str(i) + ".jpeg"
            save_path1 += str(i) + "orig.jpeg"
            ...
            img.save(save_path)
            image = torchvision.transforms.ToPILImage()(image.squeeze())
...
cifar_dataset = ImageNetKaggle("/home/ss6712/deep-trial/imagenet", "val", test_transform)
